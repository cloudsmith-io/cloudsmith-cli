...
.venv/py2/bin/pip-compile --pre --output-file development.py2.txt common.in development.in test.in
...
.venv/py3/bin/pip-compile --pre --output-file development.py3.txt common.in development.in test.in
