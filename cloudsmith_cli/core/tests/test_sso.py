...
from cloudsmith_cli.core.sso import get_access_token_expiry, renew_sso_session

API_HOST = "https://api.example.com"


def test_malformed_base64_token_has_no_readable_expiry():
    assert get_access_token_expiry("header.%%%invalid%%%.signature") is None
